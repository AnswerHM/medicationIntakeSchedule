...
public class SolarTerms { 
	...
	//
	public final static Map<String, String> SOLARTERMSMAP = new HashMap<String, String>() ;
	...
	static { 
		...
		SOLARTERMSMAP.put("2", "LICHUN") ;
		SOLARTERMSMAP.put("3", "JINGZHE") ;
		SOLARTERMSMAP.put("4", "QINGMING") ;
		SOLARTERMSMAP.put("5", "LIXIA") ;
		SOLARTERMSMAP.put("6", "MANGZHONG") ;
		SOLARTERMSMAP.put("7", "XIAOSHU") ;
		SOLARTERMSMAP.put("8", "LIQIU") ;
		SOLARTERMSMAP.put("9", "BAILU") ;
		SOLARTERMSMAP.put("10", "HANLU") ;
		SOLARTERMSMAP.put("11", "LIDONG") ;
		SOLARTERMSMAP.put("12", "DAXUE") ;
		SOLARTERMSMAP.put("1", "XIAOHAN") ;
	} 
